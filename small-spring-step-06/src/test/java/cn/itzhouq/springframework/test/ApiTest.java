...
import cn.itzhouq.springframework.test.common.MyBeanFactoryPostProcessor;
import cn.itzhouq.springframework.test.common.MyBeanPostProcessor;
...
public class ApiTest {
    ...
    public void test_BeanFactoryPostProcessorAndBeanPostProcessor() {
        ...
        System.out.println("测试结果：" + result); // 测试结果：小付哥
    }
